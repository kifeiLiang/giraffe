<template>
  <div :class="classes" :style="selectStyles" v-docClick="close" v-winScroll="handleScroll">
    <div :class="selectClass" @click="toggleDrop" ref="rel">
      ...
      <input type="text" class="k-select-label" placeholder="请选择" v-model="label" :readonly="!filterable||disabled" :disabled="disabled" @keyup="handleKeyup" ref="input" />
...
import winScroll from "yt-ui/src/directives/winScroll";
